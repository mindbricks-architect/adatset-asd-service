...
const exposedHeaders = [
  "adatset-access-token",
  "adatset-refresh-token",
  "set-cookie",
];
if (!corsOrigin) {
  app.use(
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(__dirname, "adatset-asd-postman-collection.json");
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="adatset-asd-postman-collection.json"',
  );
